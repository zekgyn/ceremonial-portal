...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:client'])->prefix('client')->name('client.')->group(function () {
        ...
        // Route::name('events.')->group(function () {
            Route::resource('events', Client\EventController::class);
    ...
    Route::middleware(['role:vendor'])->prefix('vendor')->name('vendor.')->group(function () {
        ...
        // Route::name('packages.')->group(function () {
            Route::resource('packages', Vendor\PackageController::class);
        ...
        // Route::prefix('bookings')->name('bookings.')->group(function () {
            ...
            Route::patch('bookings/{booking}/status', [Vendor\BookingController::class, 'updateStatus'])->name('bookingsstatus');
        // });
    });
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('vendors')->name('vendors.')->group(function () {
            ...
            Route::get('/{vendor}', [Admin\VendorController::class, 'show'])->name('show');
            Route::patch('/{vendor}/verify', [Admin\VendorController::class, 'toggleVerified'])->name('verify');
        });

        Route::get('/packages/{package}', [Admin\VendorController::class, 'packageShow'])->name('packages.show');

        Route::prefix('bookings')->name('bookings.')->group(function () {
            Route::get('/', [Admin\BookingController::class, 'index'])->name('index');
            Route::post('/', [Admin\BookingController::class, 'store'])->name('store');
            Route::delete('/{booking}', [Admin\BookingController::class, 'destroy'])->name('destroy');
        });
    });
});
